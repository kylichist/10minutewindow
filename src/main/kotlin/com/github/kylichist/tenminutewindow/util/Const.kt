...
const val MINIMUM_AUTO_REFRESH_PERIOD_VALUE: Long = 15000
...
internal const val MESSAGES_FIRST_QUERY = "tr:gt(0)"
internal const val MESSAGES_SECOND_QUERY = "tr:not(:last-child)"
